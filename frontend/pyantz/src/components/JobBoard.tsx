...
import { showJobOptions } from "../store/slices/uiSlice";
...
export default function JobBoard() {
    ...
    // Handle custom right clicking context menu
    ...
    const handleContextMenu = (right_click: MouseEvent<HTMLDivElement>) => {
        ...
        setContextMenuPosition({ x: right_click.clientX, y: right_click.clientY });
    }
