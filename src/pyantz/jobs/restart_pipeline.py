...
def restart_pipeline(
    ...
    Args:
        ...
        pipeline_config (PipelineConfig): pipeline to restart
    ...
    if parameters != {}:
        ...
        if (
            ...
            msg = "Invalid parameters for restart pipeline"
            raise RuntimeError(msg)
        result = comparators[params_parsed.comparator](params_parsed.left, params_parsed.right)
        if not result:
